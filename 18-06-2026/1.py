(venv) ubuntu@ip-12-0-2-110:~/oidc_adapid/blueprints$ cat adapid_desktop_blueprint.py
...
(venv) ubuntu@ip-12-0-2-110:~/oidc_adapid/templates$ cat behavior5.html
<!DOCTYPE html>
<html>
...
(venv) ubuntu@ip-12-0-2-110:~/oidc_adapid/templates$
