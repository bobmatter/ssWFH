#here fix this 
#This is adapid_desktop_blueprint.py
...
# this is rubnning in flask ec2 instance dont worry of starting it it is taken care of just fix this adapid_desktop_blueprint.py
...
# ═════════════════════════════════════════════════════════════
# Debug — GET /idv/adapidDesktop/api/formData
# ═════════════════════════════════════════════════════════════

@adapid_desktop_blueprint.route("/idv/adapidDesktop/api/formData")
def formData():
    data = None
